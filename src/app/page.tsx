...
function TypeRacerWidget() {
  ...
  function nextSentence() {
    const nextIndex = (RACE_TEXTS.indexOf(raceText) + 1) % RACE_TEXTS.length;
    setRaceText(RACE_TEXTS[nextIndex]);
    setTyped("");
    setStartedAt(null);
    setFinishedTime(null);
    setElapsed(0);
  ...
  return (
    <div className="relative flex h-[260px] min-h-[260px] flex-col rounded-xl border border-white/10 bg-canvas p-4 text-left">
      ...
      <div className="flex flex-1 items-center">
        ...
        value={finishedTime === null ? typed : newRecord ? "Congratulations! You set a new record!" : "Can you beat the Site Record?"}
        onClick={() => finishedTime !== null && resetRace()}
        onFocus={() => {
          setIsFocused(true);
      ...
      <div className="flex h-8 items-center justify-between text-[10px] uppercase tracking-[0.13em] text-gray-500">
...
function ClickMeWidget() {
  ...
  return (
    ...
    >
      <p className="text-4xl font-semibold tracking-wide text-white sm:text-5xl">
...
function WeatherWidget() {
  ...
  return (
    <div className="col-span-2 flex min-h-[220px] flex-col items-center justify-center rounded-xl border border-white/10 bg-canvas p-4 text-center lg:col-span-1">
      <p className="text-[10px] uppercase tracking-[0.18em] text-gray-500">Birmingham, AL</p>
      ...
      {data && !loading && !error && <p className="mt-3 text-center text-[10px] uppercase tracking-[0.14em] text-gray-500">High {Math.round(data.high)}° · Low {Math.round(data.low)}°</p>}
    </div>
  );
}
  ...
  return (
    <div className="col-span-2 flex w-full min-w-0 flex-col self-start lg:col-span-2">
      <div className="flex items-center justify-between gap-4 pb-2">
        ...
        <span className="inline-flex items-center text-[10px] uppercase tracking-[0.18em] text-gray-500">
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    fetch("/api/beyond-stats", {
      ...
      .then((response) => response.json())
      .then((stats: { views: number }) => setSiteViews(stats.views))
      .catch(() => undefined);
  }, []);
  ...
  return (
    <div className="bg-canvas relative min-h-screen">
      ...
      <div className="relative z-20 font-sans text-white">
        ...
        <footer className="mx-4 mb-4 mt-8 flex w-auto max-w-6xl flex-col gap-5 rounded-xl border border-accent-subtle bg-surface px-5 py-5 text-xs text-gray-400 sm:mx-auto sm:px-6 sm:py-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-col items-center gap-4 lg:flex-row lg:justify-end">
            <span className="inline-flex items-center gap-1.5 font-mono tracking-wide">
              ...
              {siteViews === null ? "0 views" : `${siteViews.toLocaleString()} views`}
            </span>
